...
pub struct Simulation {
    ...
    buffer: glium::uniforms::UniformBuffer<SimBodies>,
}
impl Simulation {
    pub fn new(display: &RendererDisplay, size: (u32, u32)) -> Self {
        ...
        let mut buffer: glium::uniforms::UniformBuffer<SimBodies> = glium::uniforms::UniformBuffer::empty(display).unwrap();
        {
            ...
            println!("Bodies length: {}", map.bodies.len());
        }
